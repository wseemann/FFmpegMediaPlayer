    ...
    private class MultiPlayer {
        ...
        private boolean setDataSourceImpl(FFmpegMediaPlayer player, String path) {
            try {
                ...
                FFmpegMediaPlayer next = new FFmpegMediaPlayer();
                if (path.startsWith("content://")) {
                    next.setDataSource(MediaPlaybackService.this, Uri.parse(path));
                } else {
        ...
        public void setNextMediaPlayer(FFmpegMediaPlayer next) {
