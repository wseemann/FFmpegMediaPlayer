...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --enable-cross-compile --cross-prefix=mipsel-linux-android- --arch=mips --cpu=mips32r2 --enable-runtime-cpudetect --enable-yasm --disable-mipsfpu --disable-mipsdspr1 --disable-mipsdspr2 --sysroot=/tmp/servestream/sysroot/ --enable-shared --disable-symver --enable-small --optimization-flags=-O2 --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-postproc --disable-avfilter --disable-gpl --disable-encoders --disable-hwaccels --disable-muxers --disable-bsfs --disable-protocols --disable-indevs --disable-outdevs --disable-devices --disable-filters --enable-encoder=png --enable-protocol='file,http,https,mmsh,mmst,pipe,rtmp' --disable-debug --prefix=/Users/wseemann/FFmpegMediaPlayer/gradle/fmp-library/library/src/main/ffmpeg/build/ffmpeg/mips --extra-cflags='-std=c99 -O3 -Wall -pipe -fpic -fasm                 -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops                 -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone                 -Wno-psabi -Wa,--noexecstack ' --extra-ldflags= --extra-cflags=
prefix=/Users/wseemann/FFmpegMediaPlayer/gradle/fmp-library/library/src/main/ffmpeg/build/ffmpeg/mips
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/tmp/servestream/sysroot/ -isysroot /tmp/servestream/sysroot/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -std=c99 -O3 -Wall -pipe -fpic -fasm -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -Wno-psabi -Wa,--noexecstack -march=mips32r2 -std=c99 -fomit-frame-pointer -fPIC -mips32r2 -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -std=c99 -O3 -Wall -pipe -fpic -fasm -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -Wno-psabi -Wa,--noexecstack -march=mips32r2 -fPIC -mips32r2
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=mipsel-linux-android-windres
DEPWINDRES=mipsel-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/tmp/servestream/sysroot/ -isysroot /tmp/servestream/sysroot/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
